...
with_node \
  ...
  --target "/Users/jaredgraham/Desktop/raet/client/ios/Pods/Target Support Files/Pods-Raet/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-secure-store" "expo-system-ui" "expo-updates" "expo-web-browser"
